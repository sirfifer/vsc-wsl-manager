...
import { SecurityValidator, CommandContext, SecurityValidationResult } from '../../src/security/securityValidator';
    ...
    describe('Rate limiting', () => {
        ...
        it('should have different limits for different operations', async () => {
            ...
            for (const op of operations) {
                ...
                // Execute up to limit
                let lastResult: SecurityValidationResult = { allowed: true };
    ...
    describe('Suspicious pattern detection', () => {
        ...
        it('should detect rapid command execution', async () => {
            ...
            for (let i = 0; i < 5; i++) {
                const context: CommandContext = {
                    command: 'list',
                    args: ['--list', `arg${i}`], // Different args to avoid identical command detection
                    timestamp: Date.now()
                };
    ...
    describe('Audit logging', () => {
        ...
        it('should log commands when security logging is enabled', async () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith(
                '[Security Audit]',
                expect.stringContaining('"command":"list"')
            );
